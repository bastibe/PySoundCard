...
def rec(frames=None, channels=None, samplerate=None, blocking=False,
        dtype=None, out=None, mapping=None, **kwargs):
    """Record audio data.
...
def playrec(data, input_channels=None, samplerate=None, blocking=False,
            input_dtype=None, out=None, input_mapping=None,
